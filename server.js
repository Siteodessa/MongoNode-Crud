...
mongoose.connect(dbConfig.url)// Connecting to the database
.then(() => {  // console.log("Successfully connected to the database");
}).catch(err => {  // console.log('Could not connect to the database. Suggest Exiting now , you can make it via process.exit() in ur node code...');//    process.exit();
});
// MULTISERVER
