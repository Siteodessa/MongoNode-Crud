...
({
  ...
  header_type: { type: String, default: '', ru_label:'Тип шапки',  input_type: 'radio', enum: ['С тонированием', 'Без'],default:'Без' },
  image: { type: String, default: '', ru_label:'Фото',  input_type: 'single_image' },
  gif: { type: String, default: '', ru_label:'GIF Изображение',  input_type: 'single_image' },
