...
module.exports = function (grunt) { // jshint ignore:line
  ...
  grunt.initConfig({
    ...
    // This task will compile all less files upon saving to create both AdminLTE.css and z.css
    less  : {
      ...
      production   : {
        ...
        files  : {
          // compilation.css  :  source.less
          'dist/css/z.css'                     : 'build/less/AdminLTE.less',
          // AdminLTE without plugins
    ...
    uglify: {
      ...
      production: {
        files: {
          'dist/js/z.js': ['dist/js/adminlte.js']
        }
      }
    },
