...
({
  ...
  construction_characteristics:  { type: String,
              ...
              input_type: 'structure' ,
              structure_model: ["text", "text", "text", "text", "text", "text", "text", "text", "text"] ,
              structure_model_ru_label: ["Заголовок", "Первый подзаголовок", "Первое Описание", "Второй подзаголовок", "Второе Описание", "Третий подзаголовок", "Третье Описание", "Четвертый подзаголовок", "Четвертое Описание"] ,
              note_type:["Объект"]},
  prices:  { type: String,
              default: '',
