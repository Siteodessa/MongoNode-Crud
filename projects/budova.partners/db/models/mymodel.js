...
[
  ...
  {"class": "cl" , "url": "/" , "text": "listings"} ,
  {"class": "cl" , "url": "/" , "text": "news"} ,
  {"class": "cl" , "url": "/" , "text": "contact"} ,
]
d.main_nav_list = [
  {"class": "main_nav_item" , "url": "/" , "text": "Home"} ,
  {"class": "main_nav_item" , "url": "/" , "text": "About us"} ,
  {"class": "main_nav_item" , "url": "/" , "text": "listings"} ,
...
d.room_tags = [
  ...
  {"node": "span" , "class": "room_tag" , "childnode": "span" , "url": "/" , "text": "Garden"} ,
...
d.listing_details = [
  ...
  "paragraph": "Donec ullamcorper nulla non metus auctor fringi lla. Curabitur blandit tempus porttitor.",
  "iconblock": [
    { "text":"Bedrooms", "icon":"images/bedroom.png", "numbers":"4" } ,
    { "text":"Bathrooms", "icon":"images/shower.png", "numbers":"3" } ,
    { "text":"Area", "icon":"images/area.png", "numbers":"7100 Sq Ft" } ,
    { "text":"Patio", "icon":"images/patio.png", "numbers":"1" } ,
    { "text":"Garage", "icon":"images/garage.png", "numbers":"2" } ,
  ]
}
]
d.description = [
...
d.additional_details = [
    {
      "heading": "description" ,
     "list": [
      { "heading":"bedroom features:", "text":"Main Floor Master Bedroom, Walk-In Closet" } ,
      { "heading":"dining area:", "text":"Breakfast Counter/Bar, Living/Dining Combo" } ,
      { "heading":"doors & windows:", "text":"Bay Window" } ,
      { "heading":"entry location:", "text":"Mid Level" } ,
...
d.listing_video = [
    {
     ...
     "video": [
      {
      "href":"bedroom features:",
      "src":"images/listing_video.jpg" ,
      "play_src":"images/play.svg"  ,
      "alt":"video" } ,
    ] , }
]
d.map = [
...
d.footer_col_title =
    {
      "heading": "say hello" ,
      "placeholder_name": "Name is required" ,
      "placeholder_mail": "Valid email is required" ,
      "placeholder_message": "Please, write us a message" ,
